...
// Release signing: keystore.properties is NOT committed (see .gitignore).
// Without it the release build stays unsigned — everyone can build the project.
...
android {
    namespace = "com.example.wifidataguard"
    compileSdk {
        version = release(37)
    }
